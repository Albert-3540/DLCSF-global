          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-purple-100/50 p-6">
              ...
              <div className="space-y-1">
                ...
                <Link href="/students" className="flex items-center gap-3 p-3 rounded-xl hover:bg-indigo-50 transition group">
                  <Users size={20} className="text-indigo-600 group-hover:scale-110 transition" />
                  <span className="text-gray-700 font-medium">Students</span>
                  <ChevronRight size={16} className="ml-auto text-gray-400 group-hover:text-indigo-600 transition" />
                </Link>
              </div>
            </div>
