...
export default function HomePage() {
  return (
    <main>
      {/* ✅ ADD THIS SCROLLING BANNER AT THE TOP */}
      <div className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-400 py-3 overflow-hidden border-b-2 border-yellow-600">
        <div className="relative overflow-hidden">
          <div className="animate-marquee whitespace-nowrap">
            <span className="text-blue-950 font-extrabold text-lg md:text-2xl tracking-wider mx-4">
              ✝️ PREACHING THE GOSPEL IS OUR PRIORITY ✝️
            </span>
            <span className="text-blue-950 font-extrabold text-lg md:text-2xl tracking-wider mx-4">
              ✝️ PREACHING THE GOSPEL IS OUR PRIORITY ✝️
            </span>
      ...
      {/* REST OF YOUR EXISTING HOMEPAGE - KEEP EVERYTHING ELSE THE SAME */}
