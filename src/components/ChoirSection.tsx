...
export default function RecentActivities() {
  ...
  const mockActivities: Activity[] = [
    ...
    },
    {
      ...
      user: {
        ...
        avatar: '/images/choir-avatar.jpg',
        role: 'Worship Team'
      },
    ...
    },
    {
      ...
      user: {
        name: 'Sarah Johnson',
        avatar: '/images/testimony-avatar.jpg',
        role: 'Member'
      },
    ...
    },
    {
      ...
      user: {
        name: 'Events Team',
        avatar: '/images/event-avatar.jpg',
        role: 'Organizer'
      },
    ...
    },
    {
      ...
      user: {
        ...
        avatar: '/images/pastor-avatar.jpg',
    ...
    },
    {
      ...
      user: {
        ...
        avatar: '/images/bible-avatar.jpg',
        role: 'Teacher'
      },
    ...
    },
    {
      ...
      user: {
        name: 'Prayer Team',
        avatar: '/images/prayer-avatar.jpg',
        role: 'Intercessor'
      },
  ...
  const getTypeColor = (type: string) => {
    switch(type) {
      ...
      case 'choir': return 'bg-purple-500';
      case 'testimony': return 'bg-yellow-500';
      case 'event': return 'bg-blue-500';
      case 'sermon': return 'bg-green-500';
      case 'bible_study': return 'bg-indigo-500';
